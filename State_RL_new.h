...
private:
    ...
    torch::Tensor _mass_params_tensor = torch::zeros({4}, torch::dtype(torch::float32),requires_grad(false));  // 质量参数
    torch::Tensor _friction_coeffs_tensor;  // 摩擦系数
    torch::Tensor _motor_strength_tensor;  // 电机最大输出力矩
